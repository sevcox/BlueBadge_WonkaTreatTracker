    ...
    internal sealed class Configuration : DbMigrationsConfiguration<TreatTracker.Data.ApplicationDbContext>
    {
        ...
        protected override void Seed(ApplicationDbContext context)
        {
            ...
            context.Drinks.AddOrUpdate(x => x.DrinkId,
                ...
                new Drink() { DrinkId = 3, Flavor = "Root Beer", FactoryId = 1, TreatName = "Fizzy Root Beer", Description = "Root beer with an extra punch of beer", SecretIngredient = "Beer and special spice blend", Price = 2.25m, Quantity = 600, CreatedUtc = DateTimeOffset.Now, UserCreated = "wonkaIsTheMan@wonka.com" },
